class PrmViewOnlineAfterController {
    constructor(prmSearchService, $mdDialog, $timeout, $window, $location, $mdMedia) {
        console.log('>>> HELLO from PrmViewOnlineAfterController');
        this.sv = prmSearchService;
    }

    $onInit() {
        let itemData=sv.getItem();
        console.log('GOT itemdata', itemData);
    }
}

PrmViewOnlineAfterController.$inject = ['prmSearchService','$mdDialog','$timeout','$window','$location','$mdMedia'];
